    ...
    return (
        <section className="py-15 px-8 flex flex-col gap-15 items-center scroll-mt-24 lg:gap-20 lg:py-10" id="work">
            <div className="flex-1 flex flex-col gap-8 w-80 md:w-md lg:gap-20">
                ...
                <div className="bg-(--color-primary-dark)/5 border-2 border-(--color-primary-dark) flex gap-8 p-6 rounded-xl">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-(--color-text-secondary)"> <span className='text-(--color-primary-light)'>Full Stack Developer</span> (Java, Spring Boot, MySQL ,HTML, CSS, JavaScript, React) - Developed a full-stack e-commerce website using React and Spring Boot, implementing product listing and cart functionality.</p>
                        <p className="text-(--color-text-secondary)"> <span className='text-(--color-primary-light)'>Technical Support Representative</span> - Worked with Google Workspace at Accenture. Explained technical solutions in simple, non-technical terms to assist customers. Worked with team members to resolve cases and maintain high service quality.</p>
                    </div>
                </div>
            </div>
            <div className="flex-1 flex flex-col gap-8 w-80 md:w-md lg:gap-20">
                ...
                <div className="bg-(--color-primary-dark)/5 border-2 border-(--color-primary-dark) flex gap-8 p-6 rounded-xl">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-(--color-primary-light) font-bold">Cum Laude</p>
                    </div>
                </div>
                <div className="bg-(--color-primary-dark)/5 border-2 border-(--color-primary-dark) flex gap-8 p-6 rounded-xl">
                    <div className="flex flex-col justify-between items-center">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-(--color-primary-light) font-bold">Best in Work Immersion</p>
                    </div>
                </div>
            </div>
        </section>
